"""
Django settings for Techietact AI project.
...
SECRET_KEY = 'django-insecure-2syn(-hwf(7ehh3p#jo706xfu0h5rx$vwjzs&5^#w)*1h$x)q0'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "3.108.93.4"]
...
ROOT_URLCONF = 'techietact_ai.urls'
...
WSGI_APPLICATION = 'techietact_ai.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'techietactai'),
        'USER': os.getenv('DB_USER', 'root'),
        'PASSWORD': os.getenv('DB_PASSWORD', '1817'),
